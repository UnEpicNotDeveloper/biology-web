...
/*  switch(children) {
    case "2.1":
        return section2_1 = [
        {
          ...
          options: ["A. It proved that all life originated from RNA-based protocells", 
    ...
    case "6.2":
        return section6_2 = [
          ...
          {
          id: '6.2.3',
          question: " Figure 1. illustrates a model of the molecules involved in DNA replication and their placement relative to each other.  Figure 1. Model including molecules involved in DNA replication. Which of the following correctly explains where DNA replication will begin on the strand oriented 5'→3', reading from left to right?  ",
          image = "/6.2.3.png",
          ...
          options: ["A. All DNA molecules have one strand containing N-14 and one strand containing N-15.", 
          ...
          answer: "A. After one round of DNA replication, every molecule of DNA would contain one parent strand (containing N-15) and one newly synthesized strand (containing N-14).",
          explanation: " "
          },
        ];
    case "6.3":
